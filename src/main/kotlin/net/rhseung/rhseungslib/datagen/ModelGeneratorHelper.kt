...
import net.rhseung.rhseungslib.api.Text.minecraftID
import net.rhseung.rhseungslib.api.Text.modID
import java.util.function.BiConsumer
import java.util.function.Supplier

object ModelGeneratorHelper {
	object Parents {
			...
			val TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_LEFT = minecraftID("block/template_chiseled_bookshelf_slot_bottom_left")
			val TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_MID = minecraftID("block/template_chiseled_bookshelf_slot_bottom_mid")
			val TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_RIGHT = minecraftID("block/template_chiseled_bookshelf_slot_bottom_right")
	...
	fun <T: Item> ItemModelGenerator.register(item: T, parent: Identifier = Parents.GENERATED) {
		val identifier = RegistryHelper.getId(item)
		this.generate(ItemModelBuilder(identifier)
			              .setParent(parent)
			              .addTexture(identifier.toString(), prefix = "")
		)
	}
